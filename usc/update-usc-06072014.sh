...
sed -i -r -e 's/\/bin\/usr\/x-www-browser %u/\/usr\/bin\/iceweasel/g' /usr/share/applications/lxde-x-www-browser.desktop
sed -i -r -e 's/\/bin\/usr\/x-www-browser %u/\/usr\/bin\/iceweasel/g' /usr/local/share/applications/lxde-x-www-browser.desktop

sed -i -r -e 's/web-browser/iceweasel/g' /usr/share/applications/lxde-x-www-browser.desktop
sed -i -r -e 's/web-browser/iceweasel/g' /usr/local/share/applications/lxde-x-www-browser.desktop
...
rm /usr/local/share/applications/minino/****
